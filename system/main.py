...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--text-column", default="review_text", help="评论文本列名")
    parser.add_argument("--label-column", default="sentiment_label", help="情感标签列名")
    parser.add_argument("--aspect-column", default="aspect", help="属性列名")
